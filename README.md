...
This repository is designed to support a clear technical conversation:

- the code is small enough to inspect quickly
- each research layer is separated into its own module
- assumptions are explicit
- the implementation avoids overclaiming results
- the pipeline demonstrates end-to-end thinking from data to reporting

That makes it suitable for discussing research process, coding style, and model-risk awareness with recruiters, interviewers, and hiring managers.
